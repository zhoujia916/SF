        ...
        return this.each( function() {
            ...
            var sortkeys = ["shiftKey","altKey","ctrlKey"],
                ...
                addJSONData = function(data,t, rcnt, more, adjust) {
                    ...
                    var self = $(ts), ir=0,v,i,j,f=[],cur,gi=ts.p.multiselect?1:0,si=ts.p.subGrid===true?1:0,addSubGridCell,ni=ts.p.rownumbers===true?1:0,
                        arrayReader=orderedCols(gi+si+ni),
                        objectReader=reader(frd),rowReader,len,drows,idn,rd={}, fpos, idr,rowData=[],cn=(ts.p.altRows === true) ? ts.p.altclass:"",cn1;
                ...
                if (editable === "0" && !$(ind).hasClass("not-editable-row")) {
                    ...
                    $('td[role="gridcell"]',ind).each( function(i) {
                        ...
                        if(treeg) { tmp = $("span:first",this).html();}
                            ...
                            try {
                                //tony
                                //console.log("editRow unformat:" + i);
        ...
        setTreeNode : function(i, len){
            return this.each(function(){
                ...
                while(i < len){
                    ...
                    //}
                    curLevel = $($t).jqGrid('getNodeDepth', ldat);
            ...
            this.each(function(){
                ...
                switch ($t.p.treeGridModel) {
                    ...
                    case 'adjacency' :
                        ...
                        $($t.p.data).each(function(){
                            if(this[parent_id] == 0 || this[parent_id] === null || String(this[parent_id]).toLowerCase() === "null") {
                                result.push(this);
                            }
                        });
                        break;
